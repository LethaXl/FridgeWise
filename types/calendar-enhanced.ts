...
export interface OptimizedInformationPanelProps {
  ...
  sections?: Array<"summary" | "items" | "insights">;
  collapsible?: boolean;
  maxHeight?: number;
  onItemPress?: (item: FoodItem) => void;
  onSectionToggle?: (sectionKey: string, expanded: boolean) => void;
  style?: any;
  testID?: string;
}
...
// Additional performance-related types used by components
...
export interface PerformanceOptimizedCalendarProps {
  ...
  onPerformanceMetrics?: (m: CalendarPerformanceMetrics | undefined) => void;
...
export interface VirtualizedCalendarListProps {
  items?: FoodItem[];
  itemHeight?: number;
  bufferSize?: number;
  onItemPress?: (item: FoodItem) => void;
  ...
  onItemMarkUsed?: (item: FoodItem) => void;
